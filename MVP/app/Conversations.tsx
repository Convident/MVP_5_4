...
import { View, Text, StyleSheet, FlatList, ListRenderItem, Dimensions, TouchableOpacity, Animated, Easing } from 'react-native';
...
const Conversations: React.FC = () => {
    const [messages] = useState<Message[]>([
        ...
        { id: '1', text: '您好，见天有几位？', sender: 'Kiwi AI' }, // Speaker A (Waitress)
        { id: '2', text: '两位，两位。', sender: 'User' }, // Speaker B (Customer)
        { id: '3', text: '请问您们的房间号是多少？', sender: 'Kiwi AI' }, // Speaker A (Waitress)
        { id: '4', text: '二百五', sender: 'User' }, // Speaker B (Customer)
        { id: '5', text: '好的，请稍等，我带您们去座位。', sender: 'Kiwi AI' }, // Speaker A (Waitress)
        { id: '6', text: '好的好的，谢谢您', sender: 'User' }, // Speaker B (Customer)
        { id: '7', text: '那您今天有幸点我们的特色厨师餐。您可以从以下菜单中选择，有水煮蛋或煎蛋，法式早餐，美式早餐，还有中式早餐。水果和米饭在旁边的自助区，您可以随时取用。食物大约需要10到15分钟准备好。', sender: 'Kiwi AI' }, // Speaker A (Waitress)
        { id: '8', text: '好的，听起来还不错。', sender: 'User' }, // Speaker B (Customer)
        { id: '9', text: '我给您一些时间看看菜单，一会儿回来为您点单。', sender: 'Kiwi AI' }, // Speaker A (Waitress)
        { id: '10', text: '你好！先给我来一杯绿茶吧。', sender: 'User' }, // Speaker B (Customer)
        { id: '11', text: '姐姐，我们可点了。', sender: 'Kiwi AI' }, // Speaker A (Waitress)
        { id: '12', text: '绿茶一杯。', sender: 'User' }, // Speaker B (Customer)
        { id: '13', text: '好的，绿茶一杯。在有什么？', sender: 'Kiwi AI' }, // Speaker A (Waitress)
        { id: '14', text: '再来一份法式早餐吧，另外请给我朋友来一份中式早餐。', sender: 'User' }, // Speaker B (Customer)
        { id: '15', text: '好的，一份法式早餐和一份中式早餐。 明白了。还有其他需要的吗？', sender: 'Kiwi AI' }, // Speaker A (Waitress)
        { id: '16', text: '好的，就点这，谢谢，谢谢。', sender: 'User' }, // Speaker B (Customer)
        { id: '17', text: '好的，有问题请教。', sender: 'Kiwi AI' } // Speaker A (Waitress)
    ]);
...
const styles = StyleSheet.create({
    ...
    footer: {
        ...
        width: '100%',
        alignItems: 'center',
        paddingBottom: 10, // Space between waves and mic button
        backgroundColor: '#fff',
        paddingTop: 10,
    },
    // mic button style
    micButton: {
        ...
        alignItems: 'center',
        position: 'relative',
        marginTop: 0, // Add space between waves and mic button
    },
    // ripple effect style
    ripple: {
        position: 'absolute',
...
/*import React, { useRef, useEffect, useState } from 'react';
import { View, Text, StyleSheet, FlatList, ListRenderItem, Dimensions, TouchableOpacity } from 'react-native';
import { GestureHandlerRootView } from 'react-native-gesture-handler';
...
const Conversations: React.FC = () => {
    ...
    const handleNextMessage = () => {
        setCurrentStep(prevStep => Math.min(prevStep + 1, messages.length - 1)); // Move to the next step
    };
...
/* most recent copy that the recording works a bit, no expo-av issue fix mic button
    ...
    const stopRecording = async () => {
        ...
        if (recording) {
            ...
            if (uri) {
                ...
                const time = Date.now();
                const fname = `audio/recording-${time}.m4a`;
        ...
        <GestureHandlerRootView style={{ flex: 1 }}>
            <View style={styles.container}>
                <View style={styles.headerContainer}>
                    ...
                    <View style={styles.topicBox}>
                        <Text style={styles.topicText}>Buying buns at the local market</Text>
                        <Text style={styles.topicDescription}>
                            It is Saturday! You decided to head to your town's morning market to buy some fresh buns. Tell the vendor what your favorite buns are and try to bargain the price.
                        </Text>
                    </View>
                </View>
                {currentStep === 0 ? (
                ...
                <View style={styles.footer}>
                    <TouchableOpacity
                        ...
                        onPressOut={stopRecording} // Stop recording when button is released
                    >
                        <Text style={styles.micButtonText}>🎤</Text>
                    </TouchableOpacity>
                </View>
...
/*
// actual latest working copy, removed audio waves, step function included
